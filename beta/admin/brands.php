...
<head>
    ...
    <title>Otlob Online | Brands</title>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-2 form-group">
                                ...
                                <input type="text" placeholder="Add New Brand" class="form-control" id="brandNameNew">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Brand Image</label><br>

                                <div class="form-group">
                                    <input  required="required" type="file" class="form-control" id="brandPhotoInput" placeholder="Brand Photo">
                                </div>
                            </div>
