            ...
            <div>
                <div class="box box-info">
                        ...
                        <div class="box-header with-border">
                            <label style="font-size: 20px;">Add New Waiter</label>
                            <div style="margin-top: 20px;" class="row">
<form id="FormAdd" method="post">
                                <div class="col-md-4 form-group">
                                    <label>Waiter Name</label>
                                    <input type="text" class="form-control" placeholder="Waiter Name" required="required" id="waiterName"/>
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>Waiter Email</label>
                                    <input type="email" class="form-control" placeholder="Waiter Email" required="required" id="waiterEmail"/>
                                </div>
                                <div class="col-md-3 form-group">
                                    <label>Waiter Rating</label>
                                    <input type="text" class="form-control number_input" placeholder="Waiter Rating" required="required" id="waiterRating"/>
                                </div>
...
<script src="dist/js/waiters.js"></script>
